# -*- coding: utf-8 -*-
"""
MECH2700 Example Code
A linear algebra calculator to demonstrate how to
calculate internal truss forces. 

@author:  Alex Muirhead
@date:    Wed Oct 11 19:51:13 2017
@title:   MECH2700-TrussAnalysis
@version: 1.1.2
@python:  3.6.1
"""
...
beamLength = 1.8  # [m]
trussHeight = 1.8  # [m]
memberOfInterest = 'Tcd'   # PICK FROM DICTIONARY ABOVE
maxMemberForce = 31977.567  # [N]

# ===========================

assert memberOfInterest in MEMBERS, \
    "Invalid member name, choose from the defined dictionary"

L = pow(beamLength**2 + trussHeight**2, 0.5)
cos = a / L
sin = b / L
